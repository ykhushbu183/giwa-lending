  ...
  if (!address) {
    return (
      <div className="animate-in text-center" style={{ maxWidth: 560, margin: "0 auto", padding: "60px 16px" }}>
        ...
        <p style={{ color: "var(--text-secondary)", marginBottom: 24, fontSize: 14 }}>Lend & borrow GLT on GIWA Sepolia</p>
      ...
      <div className="card" style={{ marginBottom: 16 }}>
        ...
        <div style={{ padding: "0 18px 6px" }}>
          <p style={{ fontSize: 11, color: "var(--text-secondary)", lineHeight: 1.5, margin: 0 }}>
            GLT is a test ERC20 token with a <strong>public mint function</strong> — anyone can mint.
